...
from ciagent.engine.results import LayerStatus, QueryResult

if TYPE_CHECKING:
    from ciagent.engine.stability import StabilityReport
...
def _emit_html(
    ...
    # Get version
    try:
        from ciagent import __version__ as version
    except ImportError:
        version = "dev"
